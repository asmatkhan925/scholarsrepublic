    ...
    <>
      ...
      >
        <LegalSection title="Why Verification Matters">
          <p>
            Scholarship information changes frequently. Deadlines, eligibility rules, funding
            details, application links, and document requirements may be updated by official
            providers. Scholars Republic aims to make scholarship discovery clearer by organizing
            important details and pointing students back to official sources.
          </p>
        </LegalSection>
        ...
        <LegalSection title={'What "Verified" Means'}>
          <p>
            ...
            and checked key details such as title, provider, country, deadline, degree level,
            funding type, eligibility notes, and application/source link where available.
          </p>
        </LegalSection>
        ...
        <LegalSection title="Expired or Uncertain Listings">
          <p>
            ...
            useful. Listings with unclear information should encourage students to check the
            official source.
          </p>
        </LegalSection>
