...
type GenerationProvider = "local" | "puter";
...
const PUTER_MODEL = "claude-haiku-4-5-20251001";
...
const outputInstructions: Record<SOPOutputType, string> = {
  paragraph:
...
function extractPuterUsage(response: unknown): string {
  const responseObject = getObject(response);
...
function buildPuterPrompt(form: GenerateSOPPayload) {
...
function FormattedSOPText({ text }: { text: string }) {
