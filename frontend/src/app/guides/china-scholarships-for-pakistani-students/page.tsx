...
const scholarshipTypes = [
  {
    ...
    body:
      "This is one of the most important official routes for Pakistani students. Applicants usually need to follow HEC instructions and also complete the Chinese scholarship system requirements.",
  },
  {
    title: "Chinese University Scholarships",
    body:
      "Many Chinese universities offer their own scholarships for international students. These may be full or partial scholarships depending on the university, degree level, and program.",
  },
  {
    title: "Provincial and municipal scholarships",
    body:
      "Some Chinese provinces and cities offer scholarships through selected universities. These can be useful alternatives if a student misses the main CSC route.",
  },
  {
    title: "Research or supervisor-supported opportunities",
    body:
      "For MS and PhD applicants, a strong research profile and professor communication can help. Some programs prefer applicants who already have research alignment or pre-admission support.",
  },
];
...
const steps = [
  {
    ...
    body:
      "Use official sources such as HEC, Campus China, and university websites. Avoid relying only on WhatsApp posts, YouTube comments, or unofficial agents.",
    href: "/scholarships",
  ...
  },
  {
    ...
    body:
      "Understand whether you are applying through the HEC/CSC route, directly through a university, or through another university-specific scholarship.",
    href: "/blog",
  ...
  },
  {
    ...
    body:
      "Do not select universities only because they are famous. Check program availability, language of instruction, supervisor fit, city, ranking, and admission requirements.",
  ...
  },
  {
    ...
    body:
      "China scholarship applications often require multiple documents. Prepare your CV, study plan, SOP, recommendation letters, passport, and academic records before the deadline period.",
          ...
          <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                China is one of the most popular study destinations for Pakistani
                students because it offers government scholarships, university
                scholarships, research opportunities, and programs in many fields.
                This guide explains the main scholarship routes and how to apply
            ...
            <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
              ...
              <h2 className="mt-2 text-base font-bold text-ink">
                Search China opportunities
              </h2>
              <p className="mt-3 text-sm leading-6 text-ink/70">
                Use Scholars Republic to save China-related opportunities, track
                deadlines, and prepare your documents step by step.
              </p>
              <Link
                href="/scholarships"
      ...
      <section className="mx-auto grid max-w-6xl gap-7 px-5 py-8 md:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
        <article className="space-y-7">
          <Section title="Why China is popular among Pakistani students">
            <p>
              China has become a major destination for Pakistani students because
              of its growing universities, wide range of degree programs, strong
              engineering and technology fields, medical education options, and
              government-supported scholarship routes.
            </p>
            <p className="mt-4">
              For Pakistani applicants, the most important advantage is that
              China offers several scholarship pathways. However, students should
              not apply randomly. A successful application usually requires
              careful university selection, strong documents, and strict
          ...
          <Section title="CSC and HEC route: what students should understand">
            <p>
              The Chinese Government Scholarship is commonly known as CSC. For
              Pakistani students, one major route is through the Higher Education
              Commission of Pakistan. This route may have its own eligibility,
              testing, document, nomination, and deadline requirements.
            </p>
            <p className="mt-4">
              Students should carefully read both sides of the process: the HEC
              instructions and the Chinese scholarship system instructions. If
              the same information is required in more than one portal, make sure
              your name, degree level, university choices, and documents are
            ...
            <div className="mt-5 rounded-xl border border-saffron/30 bg-saffron/10 p-4">
              <div className="flex gap-3">
                ...
                <p className="text-sm leading-6 text-ink/75">
                  Scholarship rules can change every year. Always check the
                  latest HEC, Campus China, and university pages before making a
                  final decision.
                </p>
              </div>
            </div>
          ...
          <Section id="documents" title="Documents usually needed for China scholarships">
            <p>
              Exact document requirements depend on the scholarship route,
              university, degree level, and program language. Still, Pakistani
              students should start preparing the following documents early:
            </p>
          ...
          <Section title="Useful official sources to check">
            <p>
              Before applying, use official sources to verify deadlines, degree
              levels, eligibility, language requirements, and required documents.
            </p>
          ...
          <section className="rounded-2xl border border-pine/20 bg-gradient-to-r from-pine/10 via-white to-saffron/10 p-5 shadow-soft md:p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-ink/70">
              ...
              study plans, CVs, and professor emails.
            </p>
        ...
        <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
          ...
          <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
            ...
            <h2 className="mt-2 text-base font-bold text-ink">
              Search China scholarships
            </h2>
            <p className="mt-3 text-sm leading-6 text-ink/70">
              Find opportunities, save the relevant ones, and prepare documents
          ...
          <div className="rounded-2xl border border-saffron/30 bg-saffron/10 p-5 shadow-soft">
            ...
            <p className="mt-3 text-sm leading-6 text-ink/70">
              Start with your SOP and study plan. These documents often explain
              your academic direction, research goals, and future contribution.
            </p>
