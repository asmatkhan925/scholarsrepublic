...
export const metadata = {
  ...
  description: "A focused guide to Chinese scholarship options, including CSC, university scholarships, documents, timelines, and application strategy.",
};

const sections = [
  "Main types of scholarships in China",
  "CSC scholarship overview",
  "University scholarship options",
  "Documents commonly required",
  "How to choose universities and programs",
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 md:px-8 md:py-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
              A focused guide to Chinese scholarship options, including CSC, university scholarships, documents, timelines, and application strategy. This article page has been created as part
