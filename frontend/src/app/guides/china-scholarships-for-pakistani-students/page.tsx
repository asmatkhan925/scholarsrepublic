          ...
          <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                ...
                it offers government scholarships, university scholarships, research opportunities,
                and programs in many fields. This guide explains the main scholarship routes and how
                to apply in a focused, organized way.
              </p>
      ...
      <section className="mx-auto grid max-w-6xl gap-7 px-5 py-8 md:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
        <article className="space-y-7">
          <Section title="Why China is popular among Pakistani students">
            <p>
              ...
              universities, wide range of degree programs, strong engineering and technology fields,
              medical education options, and government-supported scholarship routes.
            </p>
            <p className="mt-4">
          ...
          <Section title="CSC and HEC route: what students should understand">
            <p>
              ...
              one major route is through the Higher Education Commission of Pakistan. This route may
              have its own eligibility, testing, document, nomination, and deadline requirements.
            </p>
            <p className="mt-4">
              Students should carefully read both sides of the process: the HEC instructions and the
              Chinese scholarship system instructions. If the same information is required in more
              than one portal, make sure your name, degree level, university choices, and documents
          ...
          <Section id="documents" title="Documents usually needed for China scholarships">
            <p>
              Exact document requirements depend on the scholarship route, university, degree level,
              and program language. Still, Pakistani students should start preparing the following
              documents early:
            </p>
          ...
          <Section title="Useful official sources to check">
            <p>
              Before applying, use official sources to verify deadlines, degree levels, eligibility,
              language requirements, and required documents.
            </p>
          ...
          <section className="rounded-2xl border border-pine/20 bg-gradient-to-r from-pine/10 via-white to-saffron/10 p-5 shadow-soft md:p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-ink/70">
              ...
              applications, and prepare stronger SOPs, study plans, CVs, and professor emails.
            </p>
        ...
        <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
          ...
          <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
            ...
            <p className="mt-3 text-sm leading-6 text-ink/70">
              Find opportunities, save the relevant ones, and prepare documents before the deadline
              period.
            </p>
            <Link
              href="/scholarships"
