...
const scholarshipTypes = [
  {
    ...
    body: "EPOS is one of the best-known DAAD routes for development-focused postgraduate study. It is usually suitable for applicants with relevant academic background and professional experience.",
  },
  {
    title: "Master’s scholarships",
    body: "Some DAAD programmes support postgraduate study in Germany. Requirements vary by subject, university, scholarship type, and language of instruction.",
  },
  {
    title: "PhD and research grants",
    body: "Research grants may support doctoral research, short-term research stays, or structured doctoral opportunities. These are especially important for research-focused applicants.",
  },
  {
    title: "Subject-specific scholarships",
    body: "DAAD also offers scholarships for specific fields or academic tracks. Students should use the official DAAD database to find the right programme.",
  },
];
...
const applicationSteps = [
  {
    ...
    body: "Start from the DAAD database and filter by country, degree level, subject, and scholarship type. Do not rely only on social media posts.",
    href: "/scholarships",
    linkText: "Search scholarships",
  },
  {
    title: "Choose a programme that matches your profile",
    body: "Check whether your degree, grades, work experience, language level, and field match the scholarship requirements before investing time in the application.",
    href: "/dashboard/profile",
    linkText: "Complete profile",
  },
  {
    title: "Prepare documents according to the official call",
    body: "DAAD applications are document-heavy. Follow the exact checklist given on the official scholarship page and the university programme page.",
    href: "/guides/scholarship-application-checklist",
    linkText: "Application checklist",
  },
  {
    title: "Write a focused motivation letter",
    body: "Your motivation letter should explain why Germany, why this programme, why your field, and how your study plan connects to your future contribution.",
...
const timeline = [
  {
    ...
    body: "Shortlist DAAD programmes, check eligibility, update your CV, and identify required language tests or certificates.",
  },
  {
    title: "Document preparation",
    body: "Prepare motivation letter, research proposal or study plan, recommendation letters, academic records, and work certificates if needed.",
  },
  {
    title: "Final submission",
    body: "Upload documents carefully, check file names and formats, submit before the deadline, and save confirmation records.",
  },
];
          ...
          <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                DAAD scholarships are among the most respected funding opportunities for students
                who want to study or conduct research in Germany. For Pakistani students, DAAD can
                be a strong option, but the application must be planned carefully because each
                programme has its own eligibility, documents, deadlines, and language requirements.
              </p>
            ...
            <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
              ...
              <p className="mt-3 text-sm leading-6 text-ink/70">
                DAAD applications are competitive. Start by checking whether your academic
                background, experience, and language proof match the scholarship.
              </p>
              <Link
                href="/dashboard/profile"
      ...
      <section className="mx-auto grid max-w-6xl gap-7 px-5 py-8 md:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
        <article className="space-y-7">
          <Section title="What is DAAD?">
            <p>
              DAAD stands for the German Academic Exchange Service. It supports international
              academic exchange, study, and research opportunities connected to Germany. For
              Pakistani students, DAAD is especially important because it provides scholarship
              options for postgraduate study, research stays, doctoral work, and development-related
              programmes.
            </p>
            <p className="mt-4">
              The important thing to understand is that DAAD is not one single scholarship with one
              fixed rule. It is a scholarship system with different programmes. Each programme may
              have different eligibility criteria, documents, selection process, and deadlines.
            </p>
          </Section>
          ...
          <Section title="Who should consider applying for DAAD?">
            <p>
              DAAD scholarships are usually suitable for students who can show a clear academic
              direction, strong preparation, and a realistic plan for how studying in Germany will
          ...
          <Section title="DAAD language requirements: English or German?">
            <p>
              DAAD language requirements depend on the scholarship and the language of instruction
              of the chosen programme. Some programmes are taught in English, some in German, and
              some may require proof of both depending on the university and subject.
            </p>
            <p className="mt-4">
              Do not assume that DAAD always requires German or always accepts English only. Check
              the official DAAD scholarship page and the target university programme page. If a
              programme asks for IELTS, TOEFL, German certificate, or another language proof,
              prepare it early.
            </p>
            ...
            <div className="mt-5 rounded-xl border border-saffron/30 bg-saffron/10 p-4">
              <div className="flex gap-3">
                ...
                <p className="text-sm leading-6 text-ink/75">
                  Language rules are programme-specific. Always verify them from the official
                  scholarship call before submitting your application.
                </p>
              </div>
            </div>
          </Section>
          ...
          <Section id="documents" title="Documents usually needed for DAAD scholarships">
            <p>
              Exact requirements vary by DAAD programme. Still, Pakistani students should usually
              start preparing these documents early:
            </p>
          ...
          <Section title="Useful official DAAD sources">
            <p>
              Before applying, use official DAAD sources to verify deadlines, eligibility, programme
              details, language requirements, and document checklists.
            </p>
          ...
          <section className="rounded-2xl border border-pine/20 bg-gradient-to-r from-pine/10 via-white to-saffron/10 p-5 shadow-soft md:p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-ink/70">
              Use Scholars Republic to search scholarships, save relevant opportunities, track your
              applications, and prepare stronger SOPs, study plans, CVs, and motivation letters.
            </p>
        ...
        <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
          ...
          <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
            ...
            <h2 className="mt-2 text-base font-bold text-ink">Search Germany scholarships</h2>
            <p className="mt-3 text-sm leading-6 text-ink/70">
              Find opportunities, save the relevant ones, and prepare your documents before the
              deadline period.
            </p>
            <Link
              href="/scholarships"
          ...
          <div className="rounded-2xl border border-saffron/30 bg-saffron/10 p-5 shadow-soft">
            <h2 className="text-base font-bold text-ink">Need help with your motivation letter?</h2>
            <p className="mt-3 text-sm leading-6 text-ink/70">
              Start with a clear SOP-style draft, then adapt it to the specific DAAD programme and
