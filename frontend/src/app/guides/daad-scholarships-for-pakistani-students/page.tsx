...
export const metadata = {
  ...
  description: "A guide to DAAD scholarship options, academic requirements, language requirements, motivation letters, and German university preparation.",
};
...
const sections = [
  ...
  "How to prepare a motivation letter",
  "How to shortlist German programs",
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 md:px-8 md:py-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
              A guide to DAAD scholarship options, academic requirements, language requirements, motivation letters, and German university preparation. This article page has been created as part
