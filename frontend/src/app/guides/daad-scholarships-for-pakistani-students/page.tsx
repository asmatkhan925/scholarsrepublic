  ...
  return (
    <>
      <GuideArticleJsonLd
        ...
        path="/guides/daad-scholarships-for-pakistani-students"
            ...
            <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                  ...
                  programme has its own eligibility, documents, deadlines, and language
                  requirements.
                </p>
          ...
          <article className="space-y-7">
            <Section title="What is DAAD?">
              <p>
                ...
                options for postgraduate study, research stays, doctoral work, and
                development-related programmes.
              </p>
              <p className="mt-4">
                The important thing to understand is that DAAD is not one single scholarship with
                one fixed rule. It is a scholarship system with different programmes. Each programme
                may have different eligibility criteria, documents, selection process, and
                deadlines.
              </p>
            </Section>
            ...
            <Section title="Useful official DAAD sources">
              <p>
                Before applying, use official DAAD sources to verify deadlines, eligibility,
                programme details, language requirements, and document checklists.
              </p>
            ...
            <section className="rounded-2xl border border-pine/20 bg-gradient-to-r from-pine/10 via-white to-saffron/10 p-5 shadow-soft md:p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-ink/70">
                ...
                your applications, and prepare stronger SOPs, study plans, CVs, and motivation
                letters.
              </p>
