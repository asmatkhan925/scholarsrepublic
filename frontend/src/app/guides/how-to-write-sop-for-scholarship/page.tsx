          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <Link href="/" className="flex items-center gap-3 text-ink">
              ...
              <span>
                ...
                <span className="text-xs text-ink/55">Scholarship guides and tools</span>
              </span>
            </Link>
      ...
      <div className="mx-auto grid max-w-6xl gap-7 px-5 py-8 md:px-8 lg:grid-cols-[minmax(0,1fr)_280px]">
        <article className="space-y-7">
          <Section title="Why your SOP matters">
            <p>
              Your transcripts show your grades. Your CV shows your activities. Your recommendation
              letters show what others think about you. But your SOP explains why you are applying,
              what you want to achieve, why you deserve funding, and how the scholarship will help
              you create impact.
            </p>
            <p className="mt-4">
          ...
          <Section title="What is an SOP for scholarship?">
            <p>
              ...
              professionally, what field you want to study, why you chose that field, why you chose
              the university or scholarship, what experience has prepared you, what your future
              ...
              <table className="w-full min-w-[620px] border-collapse text-left text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3">Project plan, feasibility, relevance, and impact</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <Section title="What scholarship committees look for">
            <p>
              Committees are not looking for fancy English. They are looking for clarity, evidence,
              direction, and fit. A strong SOP usually proves that you have a clear academic
              direction, are prepared for the program, understand why the program fits you, have
              realistic future goals, and can communicate clearly.
            </p>
          </Section>
          ...
          <Section title="Common SOP mistakes to avoid">
            <ul className="grid gap-3">
              {mistakes.map((mistake) => (
                <li key={mistake} className="rounded-xl border border-red-100 bg-red-50 px-4 py-3">
                  {mistake}
                </li>
              ))}
            </ul>
          ...
          <Section title="Sample SOP paragraph">
            <blockquote className="rounded-xl border-l-4 border-pine bg-pine/5 p-5 text-sm leading-8 text-ink/75">
              My interest in public health developed during my volunteer work at a rural health camp
              in Sindh, where I observed that many women delayed treatment because they lacked
              access to reliable health information and affordable clinical services. This
          ...
          <Section title="Recommended SOP length">
            <ul className="space-y-3">
              ...
              <li>
                <strong>If no requirement is given:</strong> one to two pages is usually reasonable.
              </li>
            </ul>
          </Section>
          ...
          <Section title="Final tips">
            ...
            <p className="mt-4">
              Your SOP should leave the committee thinking: this applicant knows who they are, knows
              what they want to study, understands why this scholarship matters, and has a realistic
              plan to use this opportunity for meaningful impact.
            </p>
          </Section>
          ...
          <section className="rounded-2xl border border-pine/20 bg-gradient-to-r from-pine/10 via-white to-saffron/10 p-5 shadow-soft md:p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-ink/70">
              ...
              draft from your profile, target scholarship, field of study, and future goals. Use it
              as a starting point, then personalize and verify every detail before submission.
            </p>
            <Link
