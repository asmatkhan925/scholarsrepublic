...
export const metadata = {
  ...
  description: "A practical guide to finding scholarships that may accept alternatives to IELTS, such as English proficiency certificates or previous English-medium education.",
};

const sections = [
  "What no-IELTS scholarship really means",
  "Common alternatives to IELTS",
  "How to request an English proficiency certificate",
  "Countries and programs where alternatives may be accepted",
  "Risks of applying without checking language rules",
  "Final checklist before applying without IELTS"
];
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 md:px-8 md:py-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
              A practical guide to finding scholarships that may accept alternatives to IELTS, such as English proficiency certificates or previous English-medium education. This article page has been created as part
