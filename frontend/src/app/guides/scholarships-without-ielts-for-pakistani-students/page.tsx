            ...
            <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                  ...
                  expensive, time-consuming, or unavailable in some situations. The good news is
                  that some universities and scholarships may accept alternative proof of English
                  ability. The important point is to verify the official requirement before you
                  apply.
                </p>
        ...
        <section className="mx-auto grid max-w-6xl gap-7 px-5 py-8 md:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
          <article className="space-y-7">
            <Section title="What does “without IELTS” actually mean?">
              <p>
                A scholarship without IELTS usually means that IELTS is not the only accepted proof
                of English language ability. The university or scholarship body may accept another
            ...
            <Section title="Where Pakistani students can search first">
              <p>
                ...
                scholarship or university page. The following areas are commonly searched by
                Pakistani students who want IELTS alternatives:
              </p>
            ...
            <section className="rounded-2xl border border-pine/20 bg-gradient-to-r from-pine/10 via-white to-saffron/10 p-5 shadow-soft md:p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-ink/70">
                Use Scholars Republic to search scholarships, save relevant opportunities, and
                prepare your documents. If a scholarship requires IELTS, you can still keep it in
                your plan; if it accepts alternatives, you can prepare those documents early.
              </p>
          ...
          <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
            ...
            <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
              ...
              <p className="mt-3 text-sm leading-6 text-ink/70">
                Start with matching opportunities, then check whether IELTS or an alternative proof
                is required.
              </p>
              <Link
                href="/scholarships"
