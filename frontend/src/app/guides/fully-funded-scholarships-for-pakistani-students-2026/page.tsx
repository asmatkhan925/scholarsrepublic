...
const scholarshipTypes = [
  {
    ...
    body: "These are offered by foreign governments or national education bodies. They often cover tuition, living allowance, accommodation support, health insurance, or travel support depending on the program.",
  },
  {
    title: "University scholarships",
    body: "Many universities offer full or partial funding for strong international students. These may be merit-based, research-based, or department-specific.",
  },
  {
    title: "Research-based funding",
    body: "For MS and PhD applicants, supervisors, labs, and research projects may provide funding. A strong CV, research direction, and professor email are important.",
  },
  {
    title: "International mobility scholarships",
    body: "Some programs allow students to study in more than one country or university. These are usually competitive and require strong documents.",
  },
];
...
const steps = [
  {
    ...
    body: "Add your education, field, target degree, country preferences, and scholarship interests so your search becomes more focused.",
    href: "/dashboard/profile",
    linkText: "Complete profile",
  },
  {
    title: "Search scholarships by country and degree",
    body: "Do not apply randomly. Start with scholarships that match your degree level, field, nationality, and document readiness.",
    href: "/scholarships",
  ...
  },
  {
    ...
    body: "A fully funded scholarship is competitive. Your SOP, CV, study plan, recommendation letters, and professor emails should be clear and personalized.",
          ...
          <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                Fully funded scholarships can help Pakistani students study abroad without carrying
                the full financial burden of tuition, living costs, and academic expenses. This
                guide explains where to start, what to prepare, and how to use Scholars Republic to
                make your search more organized.
              </p>
            ...
            <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
              <p className="text-xs font-semibold uppercase tracking-wide text-pine">Start here</p>
              <h2 className="mt-2 text-base font-bold text-ink">
                Build a focused scholarship list
              </h2>
              <p className="mt-3 text-sm leading-6 text-ink/70">
                Instead of applying randomly, use Scholars Republic to search, save, and track
      ...
      <section className="mx-auto grid max-w-6xl gap-7 px-5 py-8 md:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
        <article className="space-y-7">
          <Section title="What does fully funded usually mean?">
            <p>
              A fully funded scholarship usually means the scholarship covers the major cost of
              study. Depending on the program, this may include tuition fees, monthly stipend,
              accommodation, health insurance, travel allowance, or research support.
            </p>
            <p className="mt-4">
              However, “fully funded” does not always mean every single expense is covered. Some
              programs may not cover visa fees, document attestation, application fees, medical
              tests, or local travel. This is why students should always check the official
          ...
          <Section title="Countries Pakistani students often consider">
            <p>
              Pakistani students commonly search for fully funded opportunities in countries where
              government scholarships, university funding, and research-based support are available.
            </p>
            ...
            <p className="mt-4">
              The best country for you depends on your field, degree level, language requirement,
              academic record, and whether your profile is stronger for coursework-based or
              research-based admission.
            </p>
          </Section>
          ...
          <Section id="documents" title="Documents you should prepare early">
            <p>
              Most fully funded scholarships require a strong document package. Preparing these
              early saves time and helps you apply before deadlines.
            </p>
          ...
          <Section title="Simple 2026 application timeline">
            <div className="grid gap-4 md:grid-cols-3">
              <div className="rounded-xl border border-ink/10 bg-cream/40 p-4">
                ...
                <h3 className="mt-3 text-sm font-bold text-ink">3–6 months before deadline</h3>
                <p className="mt-2 text-sm leading-6 text-ink/70">
                  Shortlist scholarships, check eligibility, prepare documents, and contact
              ...
              <div className="rounded-xl border border-ink/10 bg-cream/40 p-4">
                ...
                <h3 className="mt-3 text-sm font-bold text-ink">1–2 months before deadline</h3>
                <p className="mt-2 text-sm leading-6 text-ink/70">
                  Finalize SOP, CV, study plan, recommendation letters, and official forms.
                </p>
              </div>

              <div className="rounded-xl border border-ink/10 bg-cream/40 p-4">
                <CheckCircle2 size={22} className="text-pine" aria-hidden="true" />
                <h3 className="mt-3 text-sm font-bold text-ink">Final week</h3>
                <p className="mt-2 text-sm leading-6 text-ink/70">
                  Review instructions, upload documents carefully, submit early, and save proof of
                  submission.
                </p>
              </div>
            </div>
          ...
          <section className="rounded-2xl border border-pine/20 bg-gradient-to-r from-pine/10 via-white to-saffron/10 p-5 shadow-soft md:p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-ink/70">
              Use Scholars Republic to search opportunities, complete your profile, save
              scholarships, track applications, and prepare better documents with our writing guides
              and AI tools.
            </p>
        ...
        <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
          ...
          <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
            ...
            <p className="mt-3 text-sm leading-6 text-ink/70">
              Find opportunities, save the relevant ones, and return later to prepare your
              documents.
            </p>
            <Link
              href="/scholarships"
