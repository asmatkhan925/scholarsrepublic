            ...
            <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                  ...
                  carrying the full financial burden of tuition, living costs, and academic
                  expenses. This guide explains where to start, what to prepare, and how to use
                  Scholars Republic to make your search more organized.
                </p>
          ...
          <article className="space-y-7">
            ...
            <Section title="Countries Pakistani students often consider">
              <p>
                ...
                government scholarships, university funding, and research-based support are
                available.
              </p>
            ...
            <section className="rounded-2xl border border-pine/20 bg-gradient-to-r from-pine/10 via-white to-saffron/10 p-5 shadow-soft md:p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-ink/70">
                ...
                scholarships, track applications, and prepare better documents with our writing
                guides and AI tools.
              </p>
