            ...
            <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                  ...
                  because it supports multiple degree levels and many fields. This guide explains
                  how to prepare a focused application without overwhelming yourself.
                </p>
        ...
        <section className="mx-auto grid max-w-6xl gap-7 px-5 py-8 md:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
          <article className="space-y-7">
            <Section title="What is Türkiye Burslari?">
              ...
              <p className="mt-4">
                ...
                combining scholarship support with university placement. This makes it attractive,
            ...
            <Section title="Who should apply?">
              <p>
                Türkiye Burslari can be a good option for Pakistani students who have a clear
                academic goal, strong documents, and enough time to prepare a careful application.
              </p>
          ...
          <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
            ...
            <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
              ...
              <p className="mt-3 text-sm leading-6 text-ink/70">
                Find opportunities, save relevant ones, and prepare your documents before the
                deadline period.
              </p>
              <Link
                href="/scholarships"
