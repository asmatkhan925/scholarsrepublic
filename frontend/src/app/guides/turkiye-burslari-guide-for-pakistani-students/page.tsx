...
const scholarshipBenefits = [
  {
    ...
    body:
      "Türkiye Scholarships is not only financial support. It also includes placement into eligible Turkish universities and programs through the scholarship process.",
  },
  {
    title: "Tuition support",
    body:
      "The scholarship generally supports tuition costs for selected students, depending on the scholarship type and program level.",
  },
  {
    title: "Monthly stipend",
    body:
      "Selected students usually receive a monthly allowance. The amount may vary by degree level and official scholarship rules.",
  },
  {
    title: "Accommodation and health support",
    body:
      "The scholarship may include accommodation and health insurance support according to official program rules.",
  },
];
...
const applicationSteps = [
  {
    ...
    body:
      "Applications should be submitted through the official Türkiye Scholarships online system. Do not pay agents or share your login details with others.",
    href: "/scholarships",
  ...
  },
  {
    ...
    body:
      "Enter your education history, grades, documents, activities, and program preferences correctly. Inconsistent information can weaken your application.",
  ...
  },
  {
    ...
    body:
      "Select programs that fit your previous education, academic performance, language ability, and future goals. Do not choose only famous universities.",
    href: "/blog",
  ...
  },
  {
    ...
    body:
      "Türkiye Burslari applications often depend strongly on written answers. Explain your academic direction, leadership, goals, and why Türkiye fits your plan.",
          ...
          <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                Türkiye Burslari is one of the most popular government-funded
                scholarship programs for international students. For Pakistani
                students, it can be a strong option because it supports multiple
                degree levels and many fields. This guide explains how to prepare
                a focused application without overwhelming yourself.
              </p>
            ...
            <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
              ...
              <p className="mt-3 text-sm leading-6 text-ink/70">
                Use Scholars Republic to organize your scholarship search,
                prepare your documents, and track your application steps.
              </p>
              <Link
                href="/scholarships"
      ...
      <section className="mx-auto grid max-w-6xl gap-7 px-5 py-8 md:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
        <article className="space-y-7">
          <Section title="What is Türkiye Burslari?">
            <p>
              Türkiye Burslari, also known as Türkiye Scholarships, is a
              government-funded scholarship program for international students
              who want to study in Türkiye. It supports full-time degree programs
              and some short-term or special programs depending on the official
              call.
            </p>
            <p className="mt-4">
              Unlike many scholarships that only provide funding, Türkiye
              Burslari is known for combining scholarship support with university
              placement. This makes it attractive, but also competitive.
            </p>
          </Section>
            ...
            <div className="mt-5 rounded-xl border border-saffron/30 bg-saffron/10 p-4">
              <div className="flex gap-3">
                ...
                <p className="text-sm leading-6 text-ink/75">
                  Benefits and amounts can change. Always verify the current
                  scholarship benefits from the official Türkiye Scholarships
          ...
          <Section title="Who should apply?">
            <p>
              Türkiye Burslari can be a good option for Pakistani students who
              have a clear academic goal, strong documents, and enough time to
              prepare a careful application.
            </p>
          ...
          <Section title="Application timeline for 2026">
            <p>
              For 2026, Türkiye Scholarships announced one main application
              period from 10 January to 20 February 2026. Students should still
              check the official website because dates and program calls can
              change.
            </p>
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-3">
              <div className="rounded-xl border border-ink/10 bg-cream/40 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-ink/70">
                  Prepare documents, update your CV, write draft answers, and
              ...
              <div className="rounded-xl border border-ink/10 bg-cream/40 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-ink/70">
                  Complete the online application carefully and submit before the
                  deadline, not in the final hours.
                </p>
              </div>
              ...
              <div className="rounded-xl border border-ink/10 bg-cream/40 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-ink/70">
                  Watch your email and portal status. If shortlisted, prepare for
                  the interview stage.
                </p>
              </div>
            </div>
          ...
          <Section id="documents" title="Documents usually needed">
            <p>
              Exact document requirements depend on your selected degree level,
              program, and official application rules. Still, Pakistani students
              should prepare the following items early:
            </p>
          ...
          <Section title="Interview preparation tips">
            <p>
              Shortlisted applicants may be invited for an interview. The
              interview is your chance to show that your application is real,
          ...
          <Section title="Useful official sources to check">
            <p>
              Always verify application dates, eligible countries, age limits,
              degree levels, and program rules from the official Türkiye
              Scholarships website before applying.
            </p>
          ...
          <section className="rounded-2xl border border-pine/20 bg-gradient-to-r from-pine/10 via-white to-saffron/10 p-5 shadow-soft md:p-6">
            ...
            <p className="mt-3 text-sm leading-7 text-ink/70">
              ...
              opportunities, track applications, and prepare stronger SOPs,
              study plans, CVs, and motivation answers.
            </p>
        ...
        <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
          ...
          <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
            ...
            <p className="mt-3 text-sm leading-6 text-ink/70">
              Find opportunities, save relevant ones, and prepare your documents
          ...
          <div className="rounded-2xl border border-saffron/30 bg-saffron/10 p-5 shadow-soft">
            <h2 className="text-base font-bold text-ink">
              Need help with motivation answers?
            </h2>
            <p className="mt-3 text-sm leading-6 text-ink/70">
              Start with a clear SOP-style draft, then adapt it to Türkiye
              Burslari application questions.
            </p>
