...
export const metadata = {
  ...
  description: "A student-friendly guide to Türkiye Burslari, including eligibility, documents, essays, recommendation letters, and interview preparation.",
};

const sections = [
  "What Türkiye Burslari offers",
  "Who can apply",
  "Documents required",
  "How to write strong application answers",
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 md:px-8 md:py-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
              A student-friendly guide to Türkiye Burslari, including eligibility, documents, essays, recommendation letters, and interview preparation. This article page has been created as part
