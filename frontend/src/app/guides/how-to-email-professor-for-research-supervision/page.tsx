...
export const metadata = {
  ...
  description: "A guide to writing a short, respectful, and effective email to professors for MS, PhD, and research-based scholarship opportunities.",
};

const sections = [
  "When you should email a professor",
  "What to include in the subject line",
  "How to introduce yourself briefly",
  "How to connect your interests with the professor's research",
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 md:px-8 md:py-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
              A guide to writing a short, respectful, and effective email to professors for MS, PhD, and research-based scholarship opportunities. This article page has been created as part
