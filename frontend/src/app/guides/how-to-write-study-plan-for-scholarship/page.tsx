...
export const metadata = {
  ...
  description: "A practical guide to explaining your academic plan, research direction, semester goals, and future contribution in a clear study plan.",
};

const sections = [
  "What a study plan is",
  "Difference between study plan and SOP",
  "How to describe your academic goals",
  "How to connect courses with future goals",
  "How to write a research-oriented study plan",
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 md:px-8 md:py-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
              A practical guide to explaining your academic plan, research direction, semester goals, and future contribution in a clear study plan. This article page has been created as part
