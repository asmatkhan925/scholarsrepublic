            ...
            <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-center">
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
                  ...
                  scholarships where the committee wants to see academic direction, preparation, and
                  a realistic plan.
                </p>
        ...
        <section className="mx-auto grid max-w-6xl gap-7 px-5 py-8 md:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
          <article className="space-y-7">
            <Section title="What is a study plan?">
              <p>
                ...
                It shows what you want to study, why you chose that area, what skills or knowledge
                you want to gain, and how your study will support your future goals.
              </p>
              <p className="mt-4">
            ...
            <Section title="Useful phrases for a study plan">
              <p>
                These phrases can help you start, but do not copy them blindly. Adapt them to your
                own field, program, and goals.
              </p>
          ...
          <aside className="space-y-5 lg:sticky lg:top-6 lg:self-start">
            ...
            <div className="rounded-2xl border border-pine/20 bg-pine/5 p-5 shadow-soft">
              ...
              <p className="mt-3 text-sm leading-6 text-ink/70">
                Your study plan should match the scholarship, degree, university, and field. Start
                by shortlisting opportunities.
              </p>
              <Link
                href="/scholarships"
            ...
            <div className="rounded-2xl border border-saffron/30 bg-saffron/10 p-5 shadow-soft">
              ...
              <p className="mt-3 text-sm leading-6 text-ink/70">
                Your SOP and study plan should support each other. Start with a clear SOP draft,
                then turn it into a study-focused plan.
              </p>
