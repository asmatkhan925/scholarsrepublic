...
export const metadata = {
  title: "Scholarship Application Checklist | Scholars Republic",
  description: "A complete checklist for preparing documents, checking eligibility, managing deadlines, and avoiding common scholarship mistakes.",
};

const sections = [
  "Eligibility checklist",
  "Academic documents checklist",
  "Writing documents checklist",
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 md:px-8 md:py-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
              A complete checklist for preparing documents, checking eligibility, managing deadlines, and avoiding common scholarship mistakes. This article page has been created as part
