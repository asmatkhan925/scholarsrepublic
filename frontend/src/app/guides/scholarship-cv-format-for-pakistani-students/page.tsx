...
export const metadata = {
  ...
  description: "A practical guide to building a scholarship CV with education, research, projects, skills, publications, awards, and leadership experience.",
};

const sections = [
  "What makes a scholarship CV different",
  "Recommended CV structure",
  "How to write education and achievements",
  "How to present projects and research",
  "Skills, certificates, and leadership sections",
        ...
        <div className="mx-auto max-w-6xl px-5 py-10 md:px-8 md:py-12">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-ink/70 md:text-base">
              A practical guide to building a scholarship CV with education, research, projects, skills, publications, awards, and leadership experience. This article page has been created as part
