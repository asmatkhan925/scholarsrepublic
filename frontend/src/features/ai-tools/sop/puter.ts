...
- Return 4 focused paragraphs unless the selected output instruction explicitly asks for a shorter paragraph summary.
...
Final reminder:
Write clean SOP paragraphs only. No markdown. No headings. No fake details. Do not repeat the prompt, student details, instructions, or labels.`;
}
