    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_country",
                    models.CharField(blank=True, default="Pakistan", max_length=100),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("Fully Funded Only", "Fully Funded Only"),
                            ("Partial Funding Acceptable", "Partial Funding Acceptable"),
                            ("Low Tuition", "Low Tuition"),
                            ("Self-Funded Possible", "Self-Funded Possible"),
                            ("Any", "Any"),
                        ],
                        max_length=60,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("No Application Fee Only", "No Application Fee Only"),
                            ("Low Application Fee", "Low Application Fee"),
                            ("Can Pay Application Fee", "Can Pay Application Fee"),
                            ("Any", "Any"),
                        ],
                        max_length=60,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            ("Chinese Acceptable", "Chinese Acceptable"),
                            ("Turkish Acceptable", "Turkish Acceptable"),
                            ("German Acceptable", "German Acceptable"),
                            ("Any", "Any"),
                        ],
                        max_length=80,
                    ),
